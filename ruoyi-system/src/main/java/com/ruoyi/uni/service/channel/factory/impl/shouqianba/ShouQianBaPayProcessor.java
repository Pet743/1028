...
@Component
@Slf4j
public class ShouQianBaPayProcessor implements PayProcessor {
    ...
    public PayChannelEnum getSupportedChannel() {
        return PayChannelEnum.SHOUQIANBA_WX;
    }
    ...
    public PaymentResultDTO processPayment(BigDecimal amount, String orderNo, PayChannelConfig channelConfig, String remark) {
        ...
        try {
            ...
            resultDTO.setPaymentMethod(PayChannelEnum.SHOUQIANBA_WX.getCode());
